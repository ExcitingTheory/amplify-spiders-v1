...
test('getRequestFailed', async () => {
  const stuff = await getRequest('bla')
  // console.log(JSON.stringify(stuff))
  expect(stuff).toStrictEqual(undefined)
});
...
test('parseYelp', async () => {
    // console.log(yelp)
    const stuff = await parseYelp(yelp, search, postalCode, domainName)
    console.log(JSON.stringify(stuff))
...
//   let stuff = await parseCitysearch(citysearch, search, postalCode, domainName)
//   console.log(JSON.stringify(stuff))
//   expect(stuff).toStrictEqual({"results":[{"status":"fulfilled","value":{"key":0,"name":"The Original Bend Transmission Company","score":0.358974358974359,"websiteUrl":"https://www.theoriginalbtc.com/"}},{"status":"fulfilled","value":{"key":1,"name":"Bend Movers","score":0.23809523809523808,"websiteUrl":""}},{"status":"fulfilled","value":{"key":2,"name":"Bend On-Site Screening","score":0.391304347826087,"websiteUrl":"http://bendonsitescreening.com/"}},{"status":"fulfilled","value":{"key":3,"name":"Bend Tree Service","score":0.2857142857142857,"websiteUrl":""}},{"status":"fulfilled","value":{"key":4,"name":"Bend Glass & Mirror","score":0.23809523809523808,"websiteUrl":"https://www.bendglassandmirror.com/"}},{"status":"fulfilled","value":{"key":5,"name":"Residence Inn By Marriott Bend","score":0.25806451612903225,"websiteUrl":""}},{"status":"fulfilled","value":{"key":6,"name":"Springhill Suites By Marriott Bend","score":0.22857142857142856,"websiteUrl":""}},{"status":"fulfilled","value":{"key":7,"name":"La Quinta Inn By Wyndham Bend","score":0.23333333333333334,"websiteUrl":""}},{"status":"fulfilled","value":{"key":8,"name":"Bend Veterinary Specialty & Emergency Center","score":0.17777777777777778,"websiteUrl":""}},{"status":"fulfilled","value":{"key":9,"name":"Therapeutic Associates Physical Thrpy-Athletic Club Of Bend","score":0.1,"websiteUrl":""}},{"status":"fulfilled","value":{"key":10,"name":"Entrada Lodge","score":0.047619047619047616,"websiteUrl":""}},{"status":"fulfilled","value":{"key":11,"name":"Central Oregon Fence Company","score":0.3448275862068966,"websiteUrl":"https://www.centraloregonfence.com/"}},{"status":"fulfilled","value":{"key":12,"name":"Bend Courier Company","score":0.6190476190476191,"websiteUrl":""}},{"status":"fulfilled","value":{"key":13,"name":"Element Bend","score":0.23809523809523808,"websiteUrl":""}},{"status":"fulfilled","value":{"key":14,"name":"Cynthia's of Bend","score":0.2857142857142857,"websiteUrl":"https://www.cscbend.com/"}},{"status":"fulfilled","value":{"key":15,"name":"BMW of Bend","score":0.23809523809523808,"websiteUrl":""}},{"status":"fulfilled","value":{"key":16,"name":"Chevrolet of Bend","score":0.2857142857142857,"websiteUrl":""}},{"status":"fulfilled","value":{"key":17,"name":"Porsche Bend","score":0.23809523809523808,"websiteUrl":""}},{"status":"fulfilled","value":{"key":18,"name":"Audi Bend","score":0.23809523809523808,"websiteUrl":""}},{"status":"fulfilled","value":{"key":19,"name":"BMW of Bend","score":0.23809523809523808,"websiteUrl":""}}],"highScore":0.6190476190476191,"foundWebsite":false,"mostLikely":12})
// });

// test('parseGoogle', async () => {
//   const stuff = await parseGoogle(google, search, postalCode, domainName)
//   console.log(JSON.stringify(stuff))
...
//   const stuff = await parseYellowpages(yellowpages, search, postalCode, domainName)
//   console.log(JSON.stringify(stuff))
//   expect(stuff).toStrictEqual({"results":[{"status":"fulfilled","value":{"key":0,"name":"Bend Brewing Company","score":0.9523809523809523}},{"status":"fulfilled","value":{"key":1,"name":"Bend Brewing Co","score":0.6666666666666666}}],"highScore":0.9523809523809523,"mostLikely":0})
// });

// test('parseFoursquare', async () => {
//   const stuff = await parseFoursquare(foursquare, search, postalCode, domainName)
//   console.log(JSON.stringify(stuff))
//   expect(stuff).toStrictEqual({"results":[{"status":"fulfilled","value":{"key":0,"name":"GoodLife Brewing Company","score":0.64}},{"status":"fulfilled","value":{"key":1,"name":"Worthy Brewing Co.","score":0.5238095238095238}},{"status":"fulfilled","value":{"key":2,"name":"10 Barrel Brewing","score":0.38095238095238093}},{"status":"fulfilled","value":{"key":3,"name":"Bend Pet Express","score":0.2857142857142857}},{"status":"fulfilled","value":{"key":4,"name":"Bend Rock Gym","score":0.23809523809523808}},{"status":"fulfilled","value":{"key":5,"name":"Farewell Bend Park","score":0.38095238095238093}},{"status":"fulfilled","value":{"key":6,"name":"Hilton Garden Inn Bend","score":0.2608695652173913}},{"status":"fulfilled","value":{"key":7,"name":"River Pig Saloon Bend","score":0.2727272727272727}},{"status":"fulfilled","value":{"key":8,"name":"Immersion Brewing","score":0.38095238095238093}},{"status":"fulfilled","value":{"key":9,"name":"Coach Outlet Bend","score":0.3333333333333333}}],"highScore":0.64,"mostLikely":0})
// });